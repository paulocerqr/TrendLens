...
VALUES
    ...
    ('TREND_CALCULATION_VERSION', '"v2-language-eligible"'::JSONB, 'Versão das agregações com exclusão explícita de vídeos linguisticamente rejeitados.'),
    ...
    ('OPPORTUNITY_CALCULATION_VERSION', '"v2-language-eligible"'::JSONB, 'Versão do ranking calculado somente sobre agregações linguisticamente elegíveis.'),
